...
class Encoder(nn.Module):
    ...
    def __init__(
        ...
        self.input_layers.add_module(
            ...
            nn.Conv2d(num_input_channels, n_features, kernel_size=4, stride=2, padding=4, bias=False), #TODO
        )
        ...
        for layer in range(extra_layers):
            self.extra_layers.add_module(
                ...
                nn.Conv2d(n_features, n_features, kernel_size=3, stride=1, padding=1, bias=False), #TODO
            )
        ...
        self.pyramid_features = nn.Sequential() #TODO
        ...
        while pyramid_dim > 4:
            ...
            self.pyramid_features.add_module(
                ...
                nn.Conv2d(in_features, out_features, kernel_size=4, stride=2, padding=1, bias=False), #TODO
            )
...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        exp_factor = math.ceil(math.log(min(input_size) // 2, 2)) - 2 #TODO
